...
namespace Hazel {
	...
	int OpenGLFramebuffer::ReadPixel(uint32_t m_DepthAttachment, int x, int y)
	{
		HZ_CORE_ASSERT(m_DepthAttachment < m_ColorAttachments.size());

		glReadBuffer(GL_COLOR_ATTACHMENT0 + m_DepthAttachment);
		int pixelData;
