...
bool Level::CollisionTest()
{
	...
	//move the collision box to Player Position
	...
	glm::vec4 pillarVertices[3] = {
		{ -0.5f + 0.1f, -0.5f + 0.1f, 0.0f, 1.0f },//left down  
		{  0.5f - 0.1f, -0.5f + 0.1f, 0.0f, 1.0f },//right down
		{  0.0f + 0.0f,  0.5f - 0.1f, 0.0f, 1.0f },//center up
	};
